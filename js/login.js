...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleSocialLogin(provider) {
        ...
        setTimeout(() => {
            ...
            logLoginEvent(provider, true);
            showSuccessToast(`Login com ${provider} realizado com sucesso!`);
    ...
    /**
     * Define estado de carregamento para botões sociais
     */
    function setSocialLoadingState(provider, loading) {
        ...
        if (loading) {
            ...
            btnText.textContent = `Entrar com ${provider.charAt(0).toUpperCase() + provider.slice(1)}`;
